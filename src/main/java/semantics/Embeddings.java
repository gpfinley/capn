...
//        scores[phraseIndex] = 0;
    ...
    /**
     * Return a word embedding that is the sum and/or difference of two or more embeddings
     * @param sums phrases to add embeddings for
     * @param differences @Nullable phrases to subtract embeddings for
     * @return a WordEmbedding representing the sums/differences
     */
    public WordEmbedding getSumVector(Collection<Phrase> sums, Collection<Phrase> differences) {
